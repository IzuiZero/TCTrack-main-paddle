...
class LRSchedulerWrapper(LRScheduler):
    def __init__(self, optimizer, last_epoch=-1):
        ...
        super(LRSchedulerWrapper, self).__init__(base_lr=optimizer._parameter_list[0]['lr'], last_epoch=last_epoch)
...
class LogScheduler(LRSchedulerWrapper):
...
class StepScheduler(LRSchedulerWrapper):
...
class MultiStepScheduler(LRSchedulerWrapper):
    def __init__(self, optimizer, start_lr=0.01, end_lr=None,
...
class LinearStepScheduler(LRSchedulerWrapper):
...
class CosStepScheduler(LRSchedulerWrapper):
    def __init__(self, optimizer, start_lr=0.01, end_lr=0.005,
                 epochs=50, last_epoch=-1, **kwargs):
        self.start_lr = start_lr
        self.end_lr = end_lr
...
class WarmUPScheduler(LRSchedulerWrapper):
...
if __name__ == '__main__':
    ...
    net = Net().parameters()
    optimizer = SGD(parameters=net, learning_rate=0.01)
