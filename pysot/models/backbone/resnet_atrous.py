...
class BasicBlock(nn.Layer):
    ...
    def __init__(self, inplanes, planes, stride=1,
        ...
        self.relu = nn.ReLU()
        self.conv2 = nn.Conv2D(planes, planes, kernel_size=3, dilation=dilation, bias_attr=False)
    ...
    def __init__(self, block, layers, used_layers):
        ...
        for m in self.sublayers():
            if isinstance(m, nn.Conv2D):
                ...
                m.weight.set_value(paddle.ParamAttr(initializer=paddle.nn.initializer.KaimingNormal()))
    ...
    def _make_layer(self, block, planes, blocks, stride=1, dilation=1):
        ...
        if stride != 1 or self.inplanes != planes * block.expansion:
            if stride == 1 and dilation == 1:
                ...
                downsample = nn.Sequential(
                    nn.Conv2D(self.inplanes, planes * block.expansion,
                              kernel_size=3, stride=stride, bias_attr=False,  # kernel=3
...
if __name__ == '__main__':
    ...
    var = paddle.randn((1, 3, 127, 127))
    net(var)
    print('*************')
    var = paddle.randn((1, 3, 255, 255))
    net(var)
